...
export type BrokerageAccountListItem = {
    ...
    source: BrokerageAccountSource;
};

/**
 * Origin of the account: SnapTrade, Plaid, or manual.
 */
export const BrokerageAccountSource = {
    PLAID: 'plaid',
    SNAPTRADE: 'snaptrade',
    MANUAL: 'manual'
} as const;
 ...
 * Origin of the account: SnapTrade, Plaid, or manual.
 */
export type BrokerageAccountSource = typeof BrokerageAccountSource[keyof typeof BrokerageAccountSource];
...
export type AccountsBrokerageListResponses = {
     ...
     */
    200: {
        accounts: Array<BrokerageAccountListItem>;
    };
};
